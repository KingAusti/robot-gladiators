var playerInfo = {
  ...
  upgradeAttack: function() {
    if (this.money >= 7) {
      window.alert("Refilling players attack by 6 for 7 dollars");
    this.attack += 6;
    this.money -= 7;    
  } else{ 
    window.alert("You dont have enough money!");
...
var fight = function(enemy){
  ...
  //if play picks "skip confirm and then stop the loop"
  if (promptFight === "skip" || promptFight === "SKIP"){
    ...
    // generate random damage value based on enemy's attach power
...
var startGame = function() {
  ...
  if (playerInfo.health > 0){
    ...
    //Add the pickedenemy.name variable's value into the fight function, where it will assume the value of the enemy.name parameter
...
var shop = function(){  
  ...
  switch (shopOptionPrompt) {
    ...
    default:
      ...
      // call shop() again to force play to pick a valid option
      shop();
      break;
  }
};
